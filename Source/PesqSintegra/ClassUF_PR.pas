...
type
  ...
  public
    ...
    [TName('Inscrição Estadual','Nome Empresarial')]
    ...
    [TName('Atividade Econômica Principal','Início das Atividades')]
    ...
    [TName('Início das Atividades','Situação Atual')]
    ...
    [TName('OBSERVAÇÃO','Consultar novo contribuinte do Paraná')]
