...
type
  ...
  public
    ...
    [TName('Atividade Econômica','Regime de Pagamento')]
    property CNAE1: String           Read FCNAE1        write FCNAE1;
    property CNAE2: TStringList      Read FCNAE2        write FCNAE2;
    [TName('Situação Cadastral Vigente','Data da Última Atualização Cadastral')]
    property Situacao: String        Read FSituacao     Write FSituacao;
    [TName('Data da Última Atualização Cadastral',10)]
    ...
    [TName('Regime de Pagamento','Situação Cadastral Vigente')]
    ...
    [TName('Telefone','Atividade Econômica')]
