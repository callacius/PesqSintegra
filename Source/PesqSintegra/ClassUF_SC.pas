...
type
  ...
  public
    ...
    [TName('Nome/Razão Estadual','ENDEREÇO')]
    property RazaoSocial: String     Read FRazaoSocial  write FRazaoSocial;
    property Fantasia: String        Read FFantasia     write FFantasia;
    [TName('UF',3)]
    property UF: String              Read FUF           write FUF;
    [TName('Código e Descrição da Atividade Econômica Principal ','Contribuinte credenciado a emitir os seguintes documentos eletrônicos abaixo')]
    ...
    [TName('Data desta Situação Cadastral',13)]
    property DataSituacao: TDateTime Read FDataSituacao write FDataSituacao;
    [TName('Data de Início de Atividade',13)]
