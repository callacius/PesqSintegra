...
type
  ...
  public
    ...
    [TName('Inscrição Estadual','Razão')]
    ...
    [TName('CNAE Fiscal Primário','CNAE Fiscal Secundário')]
    property CNAE1: String           Read FCNAE1        write FCNAE1;
    property CNAE2: TStringList      Read FCNAE2        write FCNAE2;
    [TName('Situação Cadastral Vigente','Data de Início de Atividade')]
    property Situacao: String        Read FSituacao     Write FSituacao;
    [TName('Data da Situação Cadastral','Regime de Recolhimento:')]
    property DataSituacao: TDateTime Read FDataSituacao write FDataSituacao;
    [TName('Data de Início de Atividade','Data da Situação Cadastral')]
